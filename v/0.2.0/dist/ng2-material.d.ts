...
declare module 'ng2-material/components/sidenav/sidenav' {
	import { ElementRef, OnDestroy, OnInit, QueryList, AfterViewInit, ApplicationRef, EventEmitter } from "angular2/core";
	...
	export class MdSidenav extends MdBackdrop implements OnInit, OnDestroy {
	    ...
	    transitionClass: string;
	    transitionAddClass: boolean;
	    constructor(element: ElementRef, service: SidenavService, container: MdSidenavContainer);
	    ngOnInit(): any;
	    ngOnDestroy(): any;
	    toggle(visible: boolean): Promise<void>;
	}
