...
declare module 'ng2-material/components/data_table/data_table_tr' {
...
declare module 'ng2-material/components/data_table/data_table' {
	...
	import { MdDataTableTr } from 'ng2-material/components/data_table/data_table_tr';
	export * from 'ng2-material/components/data_table/data_table_tr';
	/**
	...
	export class MdDataTable {
	     ...
	     */
	    toggleActivity(tr: MdDataTableTr): void;
	    /**
...
declare module 'ng2-material/components/peekaboo/peekaboo' {
	...
	export class MdPeekaboo implements OnDestroy {
	    ...
	    constructor(media: Media, _app: ApplicationRef);
	    ngOnDestroy(): any;
